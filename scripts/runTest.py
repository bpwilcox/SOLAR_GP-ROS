...
#YStart = np.column_stack(np.deg2rad([-30,45,30, 0,0,0])) # initial joint position
#robot = RobotModels.SerialLink([Origin, Link, Link, Link, Link, Link, LinkEnd], YStart) # Create Robot structure
#
#"Create Planar Test Case"
#n = 500 # number of points in trajetory
...
Test.runTest(njit = 25, num_inducing =25, elev = 45, azim = 245, save_plots = False, wgen = 0.1, encode_angles = True, drift = 1)